...
from general import average_KNN, all_KNN, load_model, change_type, classify_FC, Net, class_train
                ...
                for x1, y1, x2, y2, conf, cls in reversed(det):
                    ...
                    if c == 2:
                        ...
                        if last_layer == 'all_KNN':
                            ...
                            result = classify_FC(im0[y:y+h,x:x+w], resnet=resnet, net=emb_face, class_train=class_train)
                            label = result
...
if __name__ == "__main__":
    run(
        weights=ROOT_p + '/models/parameter/YOLOv5/weight_train.pt',
